...
function func_confirmar5() {
    ...
    if (ipt_contrafile.checked === true) {
        ...
        div_mensagem.innerHTML += `<b>Contrafilé:</b> ${contrafile.toFixed(2)}Kg<br>`;
    }
    ...
    if (ipt_picanhaSuina.checked === true) {
        ...
        div_mensagem.innerHTML += `<b>Picanha Suína:</b> ${picanhaSuina.toFixed(2)}Kg<br>`;
    }
    ...
    if (ipt_coracao.checked === true) {
        ...
        div_mensagem.innerHTML += `<b>Coração:</b> ${coracao.toFixed(2)}Kg<br>`;
    }
    ...
    if (ipt_carvao.checked === true) {
        ...
        div_mensagem.innerHTML += `<b>Carvão:</b> ${carvao.toFixed(2)}Kg<br>`;
    }
    ...
    if (ipt_agua.checked === true) {
        ...
        div_mensagem.innerHTML += `<b>Água:</b> ${agua.toFixed(2)}l<br>`;
    }
